...
'''
Commented out whilst trying to figure out how to get a constant output from 'ping':

set_interval = 0.25
set_count = float(input("For how long (seconds) do you wish to plot your ping for?: ")) / set_interval
'''
tagret = "8.8.8.8"
count = 0
